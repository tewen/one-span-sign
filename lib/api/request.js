...
async function oneSpanRequest({ method, route, query, apiKey, sandbox, domain, sandboxDomain }) {
  try {
...
async function oneSpanMultipartFormDataRequest({ method, route, documents, data, apiKey, sandbox, domain, sandboxDomain }) {
  try {
    const response = await request({
      method,
      uri: getRoute({
